...
import mobi.square.slots.game.slots.bonusgames.CResidentSafes;
import mobi.square.slots.game.slots.v4.CSlotsBase;
import mobi.square.slots.utils.utils;

public class Resident extends CSlotsBase {
	...
	private static final String title = "resident";
	private static final String background_path = "/SlotsWeb3/resources/img/slots/resident_bg.js";
	private static final String symbols_path = "/SlotsWeb3/resources/img/slots/resident.js";
	private static final String background_hi_path = "/SlotsWeb3/resources/img/slots/resident_bg_hi.js";
	private static final String symbols_hi_path = "/SlotsWeb3/resources/img/slots/resident_hi.js";
	...
	public int checkPayout(int amount) {
		...
		if (count_bonus >= 3) {
			...
			this.generateBonusGameSafes();
		}
		
		return amount;
	}

	public void generateBonusGameSafes() {
		CResidentSafes game_safes = new CResidentSafes(super.parent);
		game_safes.generate(super.parent.getBet() == valid_bets[valid_bets.length - 1]);
		super.parent.setBonusGameInstance(game_safes);
	}
