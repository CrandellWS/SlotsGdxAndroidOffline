...
public class BookOfRa extends CSlotsBase {
	...
	private static int[] getPays(Symbol symbol) {
		switch (symbol) {
		case WILD: return pay_table[0];
		case N01: return pay_table[1];
		case N02: return pay_table[2];
		case N03: return pay_table[3];
		case N04: return pay_table[4];
		case N05: return pay_table[5];
		case N06: return pay_table[6];
		case N07: return pay_table[7];
		case N08: return pay_table[8];
		case N09: return pay_table[9];
		default: return pay_table[0];
		}
	}
