...
public abstract class CLines implements ILines {
	...
	public static ILines newLines(CSlots slots) {
		switch (slots.getConfig().getLinesSet()) {
			case LINES_3X_20_V1:	return new CLines_3x_20_v1(slots);
			case LINES_3X_99_V1:	return new CLines_3x_99_v1(slots);
			case LINES_4X_50_V1:	return new CLines_4x_50_v1(slots);
			case LINES_3X_09_V1:	return new CLines_3x_09_v1(slots);
			default:				return null;
		}
	}
	...
	public static ILines newLines(Lines lines) {
		switch (lines) {
			case LINES_3X_20_V1:	return new CLines_3x_20_v1(null);
			case LINES_3X_99_V1:	return new CLines_3x_99_v1(null);
			case LINES_4X_50_V1:	return new CLines_4x_50_v1(null);
			case LINES_3X_09_V1:	return new CLines_3x_09_v1(null);
			default:				return null;
		}
	}
