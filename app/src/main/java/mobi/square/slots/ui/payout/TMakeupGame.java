...
public class TMakeupGame extends TBasic {
    ...
    private TMakeupGame(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        super();
    ...
    public static TMakeupGame newInstance(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        TMakeupGame instance = new TMakeupGame(background, atlas, symbols, windows_atlas);
        ...
        { // SCATTER & WILD
            ...
            ls.fontColor = black;
            label = new PixelLabel(Connection.getString("makeup_game_scatter"), ls);
            label.setBounds(146f, 0f, 250f, 140f);
            label.setAlignment(Align.top | Align.left);
            group.addActor(label);
            instance.labels.add(label);
            label = new PixelLabel(Connection.getString("makeup_game_wild"), ls);
