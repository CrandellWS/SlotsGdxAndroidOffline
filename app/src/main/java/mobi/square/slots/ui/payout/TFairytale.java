...
public class TFairytale extends TBasic {
    ...
    private TFairytale(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        super();
        this.labels = new ArrayList<PixelLabel>();
        this.background = background;
        this.shadow = new TextureRegionDrawable(atlas.findRegion("table_shadow"));
        this.title_label = TableTitle.newInstance(atlas.findRegion("title_background"), new Color(0.416f, 0f, 0f, 1f), .08f, .08f, .96f, .9f);
    ...
    public static TFairytale newInstance(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        TFairytale instance = new TFairytale(background, atlas, symbols, windows_atlas);
        instance.setBounds(0f, 0f, AppConfig.VIEWPORT_WIDTH, AppConfig.VIEWPORT_HEIGHT - GameHeader.HEADER_HEIGHT);
        instance.title_label.setBounds(65f, 384f, 774f, 114f);
        ...
        { // SCATTER & BONUS
            ...
            ls.fontColor = white;
            label = new PixelLabel(Connection.getString("fairytale_scatter"), ls);
            label.setBounds(146f, 0f, 250f, 140f);
            label.setAlignment(Align.top | Align.left);
            group.addActor(label);
            instance.labels.add(label);
            label = new PixelLabel(Connection.getString("fairytale_bonus"), ls);
        ...
        { // WILD
            ...
            ls.font = FontsFactory.getAsync("Taurus.ttf", 20);
            ls.fontColor = white;
            label = new PixelLabel(Connection.getString("fairytale_wild"), ls);
            label.setBounds(146f, 0f, 250f, 140f);
            label.setAlignment(Align.top | Align.left);
            group.addActor(label);
            instance.labels.add(label);
