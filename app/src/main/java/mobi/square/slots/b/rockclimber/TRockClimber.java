...
public class TRockClimber extends TBasic {
    ...
    private TRockClimber(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        super();
    ...
    public static TRockClimber newInstance(Texture background, TextureAtlas atlas, TextureAtlas symbols, TextureAtlas windows_atlas) {
        TRockClimber instance = new TRockClimber(background, atlas, symbols, windows_atlas);
        ...
        { // Bonus symbols
            ...
            PixelLabel label = new PixelLabel(Connection.getString("rock_climber_bonus"), ls);
            label.setBounds(197f, 0f, 250f, 160f);
            label.setAlignment(Align.top | Align.left);
            group.addActor(label);
            instance.labels.add(label);
            // Symbols
            TableSymbol symbol = TableSymbol.newInstance(null, bonus, 0f, 0f, 1f, 1f);
            symbol.setBounds(25f, 0f, 160f, 170f);
