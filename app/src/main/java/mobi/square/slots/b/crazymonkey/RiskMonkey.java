...
public class RiskMonkey extends Header {

    private RiskMonkeyGroup risk;
    ...
    public RiskMonkey(SBasic parent) {
        super(parent);
        this.risk = null;
    ...
    public void load(LoadingHandler handler) {
        super.load(false);
        Texture background = Connection.getManager().get("CrazyMonkey/CrazyMonkeyRiskBg.jpg", Texture.class);
        TextureAtlas cards_atlas = Connection.getManager().get("CrazyMonkey/CrazyMonkeyCards.pack", TextureAtlas.class);
        TextureAtlas ani_atlas = Connection.getManager().get("CrazyMonkey/CrazyMonkeyAniR.pack", TextureAtlas.class);
        TextureAtlas atlas = Connection.getManager().get("CrazyMonkey/CrazyMonkeyRisk.pack", TextureAtlas.class);
        this.risk = RiskMonkeyGroup.newInstance(background, atlas, cards_atlas, ani_atlas);
        ...
        this.risk.setHelmeted(Connection.getInstance().isMaxBet());
        super.updateInfo();
    }
