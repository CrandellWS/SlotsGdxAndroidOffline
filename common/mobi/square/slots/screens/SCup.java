...
import mobi.square.slots.stages.Cup;

public class SCup extends SBasic {

	private SlotsType type;

	public SCup(SlotsType type) {
		super(null);
		super.stage = new Cup(this, type);
		this.type = type;
	}

	public SCup(Game parent, SlotsType type) {
		super(parent);
		super.stage = new Cup(this, type);
		this.type = type;
	}
	...
	public void show() {
		if (super.stage == null)
			super.stage = new Cup(this, this.type);
		super.show();
	}
	...
	public FontInfo[] getFontsList() {
		...
		return super.getFontsList(new FontInfo[] {
			...
			new FontInfo("whitrabt.ttf", 21f, true),
	...
	public SoundInfo[] getSoundList() {
		...
		return super.getSoundList(new SoundInfo[] {
			new SoundInfo(SoundList.LINE_WINS, false),
