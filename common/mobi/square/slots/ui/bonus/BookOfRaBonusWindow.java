...
public class BookOfRaBonusWindow extends Group implements Resizable {
	...
	private static class BonusSymbolBook extends Group implements Resizable {
		...
		public static interface BonusSymbolChoosen {
			public void symbolChoosen();
		}
		...
		public void beginSwitch(SymbolType target) {
			...
			switch (target) {
				case N01:	this.target_index = 0;	break;
				case N02:	this.target_index = 1;	break;
				case N03:	this.target_index = 2;	break;
				case N04:	this.target_index = 3;	break;
				case N05:	this.target_index = 4;	break;
				case N06:	this.target_index = 5;	break;
				case N07:	this.target_index = 6;	break;
				case N08:	this.target_index = 7;	break;
				default:	this.target_index = 0;	break;
			}
		}
		public void setSpinsCount(int count) {
