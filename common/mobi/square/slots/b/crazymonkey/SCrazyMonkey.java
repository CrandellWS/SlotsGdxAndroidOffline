...
public class SCrazyMonkey extends SBasic {

	private SlotsType type;

	public SCrazyMonkey() {
		super(null);
		this.type = SlotsType.CRAZY_MONKEY;
		super.stage = new CrazyMonkey(this);
	}

	public SCrazyMonkey(Game parent) {
		super(parent);
		this.type = SlotsType.CRAZY_MONKEY;
		super.stage = new CrazyMonkey(this);
	}
	...
	public AtlasInfo[] getAtlasList() {
		...
		return super.getAtlasList(new AtlasInfo[] {
			...
			new AtlasInfo("CrazyMonkey/CrazyMonkeyAni.pack", false),
	...
	public SoundInfo[] getSoundList() {
		...
		return super.getSoundList(new SoundInfo[] {
			new SoundInfo("CrazyMonkey/bonus_game.ogg", false),
			new SoundInfo("CrazyMonkey/change_bet.ogg", false),
			new SoundInfo("CrazyMonkey/change_lines.ogg", false),
			new SoundInfo("CrazyMonkey/reel_stop.ogg", false),
			new SoundInfo("CrazyMonkey/spin_time.ogg", false),
